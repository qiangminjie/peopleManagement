...
function updateStaff($id, $name, $sex, $education, $school, $major, $birthday, $age, $type, $subtype, $level, $status, $in_time, $out_time) {
    $sql = "update staff set name=:name, sex=:sex, education=:education, school=:school, major=:major, birthday=:birthday, age=:age, type=:type, 
            subtype=:subtype, level=:level, status=:status, in_time=:in_time";
    if($out_time !== ""){
...
function addStaff($number, $name, $sex, $education, $school, $major, $birthday, $age, $type, $subtype, $level, $status, $in_time, $out_time) {
    $sql = "INSERT INTO staff(number, name, sex, education, school, major, birthday, age, type, subtype, level, status, in_time, out_time) 
            VALUES (:number, :name, :sex, :education, :school, :major, :birthday, :age, :type, :subtype, :level, :status, :in_time, :out_time)";
    ...
    try {
        ...
        switch ($condition) {
            case 'only':
                ...
                break;
            case 'all':
                $sql = 'SELECT a.*, x.type_name, x.subtype_name, x.level_name FROM staff a, 
...
function getStaffList($number, $name, $type, $subtype, $level, $page_flag = false, $page = 1, $pageSize = 10) {
