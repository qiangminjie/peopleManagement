...
class ValidateCode {
  ...
  public function __construct() {
    $this->font = dirname(__FILE__).'/../../resource/fonts/elephant.ttf';
  }
  ...
  private function createFont() {
    ...
    for ($i = 0; $i < $this->codelen; $i++) {
        ...
        imagettftext($this->img,$this->fontsize, mt_rand(-30,30), $_x * $i + mt_rand(1,5)
            , $this->height / 1.4, $this->fontcolor, $this->font, $this->code[$i]);
    }
  }
