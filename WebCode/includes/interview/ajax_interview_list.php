...
require_once dirname(__FILE__) . "/sql_interview_list.php";
...
//} else {
    switch ($_POST["code"]) {
        case 0:
            ...
            $list = getintervewerList($number, $name, $type, $subtype, $level,$isoffer);
        ...
        case 2:
            ...
            if ($age < 0) {
                ...
                $resp_code = addInterviewer($number, $name, $sex, $education, $school, $major, $birthday, $age, cvtnullto0($type), cvtnullto0($subtype), cvtnullto0($level), $status, $in_time);
                switch ($resp_code) {
                    case 0:
                        $resp_info = "操作成功！";
                        break;
        ...
        case 7:
            ...
            $list = getintervewerOfferList($number, $name, $type, $subtype, $level);
