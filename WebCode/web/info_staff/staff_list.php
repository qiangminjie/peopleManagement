...
<!-- 新增modal -->
<div class="modal fade" id="createStaff" tabindex="-1" role="dialog" data-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">新建员工
          <small class="alert-danger" style="margin: 28px"></small>
        </h4>
      </div>
          ...
          <div class="form-group" id="create-form-status">
            ...
            <div class="col-md-9">
              <select name="status" id="select-create-status" class="form-control">
                ...
                <option value="0" disabled>离职</option>
              </select>
            </div>
          </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal" data-toggle="tooltip" data-placement="left">取消</button>
        <button type="button" class="btn btn-primary" id="createStaff-submit">确定</button>
      </div>
    </div>
  </div>
</div>
        ...
        $(".staff-info").click(function () {
            ...
            $.ajax({
                ...
                success:function (json) {
                    $(".se-pre-con").fadeOut();
                    //console.log(json);
                    $('#select_modal_name').val(json.name);
                },
                error:function (textStatus, errorThrown) {
                    $(".se-pre-con").fadeOut();
                    showSingleButtonNoty("服务器内部错误,请稍后重试. 如果此问题重复出现,请联系网站管理人员", "error", 0);
